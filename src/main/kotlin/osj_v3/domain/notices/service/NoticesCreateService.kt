...
import osj_v3.domain.fcm.service.FcmSendCreatedNotificationService
...
class NoticesCreateService(
    ...
    private val fcmSendCreatedNotificationService: FcmSendCreatedNotificationService
) {
    fun createNotices(noticesCreateDto: NoticesCreateDto): NoticesDto{
        ...
        fcmSendCreatedNotificationService.sendNotices(
            NoticePayloadDto(
